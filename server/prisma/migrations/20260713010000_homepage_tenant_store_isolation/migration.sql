...
CREATE INDEX "Tenant_status_storefrontEnabled_idx"
...
CREATE INDEX "Store_status_storefrontEnabled_idx"
...
CREATE UNIQUE INDEX "StorefrontDomain_hostname_key"
  ON "StorefrontDomain"("hostname");
CREATE INDEX "StorefrontDomain_tenantId_storeId_idx"
  ON "StorefrontDomain"("tenantId", "storeId");
CREATE INDEX "StorefrontDomain_status_idx"
