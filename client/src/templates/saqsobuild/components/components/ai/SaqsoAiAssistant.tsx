...
export default function SaqsoAiAssistant() {
  ...
  return <>
    {open ? <section role="dialog" aria-label="AI shopping assistant" className="fixed inset-x-3 bottom-20 z-[90] max-h-[70vh] overflow-y-auto rounded-lg border border-zinc-200 bg-white shadow-2xl dark:border-zinc-800 dark:bg-zinc-950 sm:left-auto sm:right-5 sm:w-96">
