...
export const HOMEPAGE_SECTION_ALIASES: Readonly<Record<string, HomepageSectionKey | null>> = {
  ...
  PRODUCT_RAIL: "PRODUCT_RAIL", FEATURED_PRODUCTS: "PRODUCT_RAIL", NEW_ARRIVALS: "PRODUCT_RAIL", BEST_SELLERS: "PRODUCT_RAIL", TRENDING: "PRODUCT_RAIL", TRENDING_PRODUCTS: "PRODUCT_RAIL",
  CAMPAIGN: "CAMPAIGN", FLASH_SALE: "CAMPAIGN", DEALS: "CAMPAIGN",
  COLLECTION: "COLLECTION", COLLECTIONS: "COLLECTION", COLLECTION_GRID: "COLLECTION", LOOKBOOK: "COLLECTION",
  SOCIAL_FEED: "SOCIAL_FEED", INSTAGRAM_FEED: "SOCIAL_FEED", FACEBOOK_FEED: "SOCIAL_FEED", UGC: "SOCIAL_FEED",
  NEWSLETTER: "NEWSLETTER",
  MEMBERSHIP: "MEMBERSHIP", AI_MEMBERSHIP: "MEMBERSHIP", MEMBERSHIP_BANNER: "MEMBERSHIP", REWARDS: "MEMBERSHIP",
};
