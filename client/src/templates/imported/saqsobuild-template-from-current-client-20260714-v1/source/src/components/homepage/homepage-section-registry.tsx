...
const NoRenderer: RegisteredRenderer | null = null;
...
export const homepageSectionRegistry: Readonly<Record<HomepageSectionKey, Definition>> = {
  ...
  PRODUCT_RAIL: definition("PRODUCT_RAIL", "Product Rail", "Catalog", ["FEATURED_PRODUCTS", "NEW_ARRIVALS", "BEST_SELLERS", "TRENDING"], NoRenderer, "API"),
