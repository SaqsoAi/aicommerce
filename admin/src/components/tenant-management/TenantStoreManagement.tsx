    ...
    <main className={styles.page}>
      ...
      >
        ...
        <div className={styles.headerActions} style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          <Link href="/system/template-catalog" className={styles.headerAction} style={action}>
            Template Catalog
          </Link>
          <Link href="/system/runtime-domain" className={styles.headerAction} style={action}>
            Runtime & Domains
          </Link>
          <button className={styles.headerAction} style={action} onClick={() => void load()} disabled={busy}>
            Refresh
          </button>
        </div>
      </header>
      ...
      {editTenant ? (
        <section style={{ ...card, marginTop: 16 }}>
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 12 }}>
            ...
            <button className={styles.headerAction} style={action} onClick={() => setEditTenant(null)}>
              Cancel
            </button>
          </div>
        </section>
      ...
      {editStore ? (
        <section style={{ ...card, marginTop: 16 }}>
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 12 }}>
            ...
            <button className={styles.headerAction} style={action} onClick={() => setEditStore(null)}>
              Cancel
            </button>
          </div>
        </section>
        ...
        >
          {catalog.tenants.map((tenant) => (
            <article key={tenant.id} style={card}>
              <div className={styles.entityHeader} style={{ display: "flex", justifyContent: "space-between" }}>
                <div>
