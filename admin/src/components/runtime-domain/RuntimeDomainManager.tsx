    ...
    <main style={{ padding: 24, color: "#e5eefc" }}>
      ...
      >
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          <Link href="/system/tenant-management" style={{ ...input, width: "auto", textDecoration: "none" }}>
            Tenant Management
          </Link>
          <Link href="/system/template-catalog" style={{ ...input, width: "auto", textDecoration: "none" }}>
            Template Catalog
          </Link>
          <button style={{ ...input, width: "auto" }} onClick={() => void load()} disabled={busy}>
            Refresh
          </button>
        </div>
      </header>
      ...
      <section style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(310px,1fr))", gap: 16 }}>
        <div style={panel}>
